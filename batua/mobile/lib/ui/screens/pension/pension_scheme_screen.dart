...
class PensionSchemeScreen extends ConsumerStatefulWidget {
  const PensionSchemeScreen({super.key});
  
  @override
  ConsumerState<PensionSchemeScreen> createState() => _PensionSchemeScreenState();
}

class _PensionSchemeScreenState extends ConsumerState<PensionSchemeScreen> 
    with SingleTickerProviderStateMixin {
  late TabController _tabController;
  bool _isLoading = false;
  
  // Mock data - replace with actual API calls
  final List<PensionPlan> _pensionPlans = [
    PensionPlan(
      id: 'gram_basic',
      name: 'Gram Basic',
      description: 'Basic pension plan for rural India',
    ...
    PensionPlan(
      id: 'gram_premium',
      name: 'Gram Premium',
      description: 'Premium pension plan with higher returns',
  ...
  Widget _buildPlansTab() {
    return ListView.builder(
      padding: const EdgeInsets.all(20),
      itemCount: _pensionPlans.length,
      itemBuilder: (context, index) {
        final plan = _pensionPlans[index];
  ...
  void _calculatePension() {
    // TODO: Implement pension calculation
    AppLogger.info('Calculating pension returns');
  }
}

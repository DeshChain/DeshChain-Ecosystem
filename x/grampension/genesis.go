...
import (
	...
	"github.com/deshchain/deshchain/x/grampension/keeper"
...
type GenesisState struct {
	...
	Schemes             []types.PensionScheme     `json:"schemes"`
	Participants        []types.PensionParticipant `json:"participants"`
	Contributions       []types.PensionContribution `json:"contributions"`
	Maturities          []types.PensionMaturity   `json:"maturities"`
...
func DefaultGenesis() *GenesisState {
	return &GenesisState{
		...
		Schemes:       []types.PensionScheme{},
		Participants:  []types.PensionParticipant{},
		Contributions: []types.PensionContribution{},
		Maturities:    []types.PensionMaturity{},

...
func (k Keeper) EnrollParticipant(ctx sdk.Context, participant types.PensionParticipant) error {
	// Get scheme
...
func (k Keeper) SetParticipant(ctx sdk.Context, participant types.PensionParticipant) {
...
func (k Keeper) GetParticipant(ctx sdk.Context, participantID string) (types.PensionParticipant, bool) {
	store := ctx.KVStore(k.storeKey)
	bz := store.Get(types.ParticipantPrefix.Bytes(append([]byte(participantID)))
	if bz == nil {
		return types.PensionParticipant{}, false
	}

	var participant types.PensionParticipant
	k.cdc.MustUnmarshal(bz, &participant)
	return participant, true
}

// GetParticipantByAddress retrieves a participant by address and scheme
func (k Keeper) GetParticipantByAddress(ctx sdk.Context, address sdk.AccAddress, schemeID string) (types.PensionParticipant, bool) {
...
func (k Keeper) IterateParticipantsByScheme(ctx sdk.Context, schemeID string, cb func(types.PensionParticipant) bool) {
	store := ctx.KVStore(k.storeKey)
...
func (k Keeper) GetActiveParticipants(ctx sdk.Context, schemeID string) []types.PensionParticipant {
	var participants []types.PensionParticipant
	k.IterateParticipantsByScheme(ctx, schemeID, func(participant types.PensionParticipant) bool {
...
func (k Keeper) CheckParticipantDefaults(ctx sdk.Context) {
	...
	k.IterateSchemes(ctx, func(scheme types.PensionScheme) bool {
		if scheme.Status != types.StatusActive {
			return false
		}

		k.IterateParticipantsByScheme(ctx, scheme.SchemeID, func(participant types.PensionParticipant) bool {
			if participant.Status != types.StatusActive {
				return false
			}

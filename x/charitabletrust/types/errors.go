...
var (
	...
	ErrOrganizationUnderInvestigation = sdkerrors.Register(ModuleName, 25, "organization under fraud investigation")
	ErrOrganizationFraudulent        = sdkerrors.Register(ModuleName, 26, "organization has confirmed fraud case")
	ErrOrganizationSuspended         = sdkerrors.Register(ModuleName, 27, "organization suspended due to fraud concerns")
	ErrOrganizationHighRisk          = sdkerrors.Register(ModuleName, 28, "organization classified as high risk")
	ErrInvalidOrganization           = sdkerrors.Register(ModuleName, 29, "invalid organization")
	ErrInvalidAddress                = sdkerrors.Register(ModuleName, 30, "invalid address")
	ErrModuleDisabled                = sdkerrors.Register(ModuleName, 31, "module is disabled")
	ErrTrustFundNotInitialized       = sdkerrors.Register(ModuleName, 32, "trust fund not initialized")
)
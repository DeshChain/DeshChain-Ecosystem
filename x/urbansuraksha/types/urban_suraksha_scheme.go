...
// UrbanSurakshaScheme represents the Urban Pension Scheme with integrated services
type UrbanSurakshaScheme struct {
...
type UrbanUnifiedPool struct {
	...
	SurakshaReserve      sdk.Coin  `json:"suraksha_reserve"`       // 25% - For maturity payments
...
const (
	...
	UrbanSurakshaContributionPeriod  = 18   // 18 months
	UrbanSurakshaMaturityMonth       = 20   // Returns on 20th month
	...
	SurakshaReserveAllocation  = 25 // 25%
...
// Validate validates the UrbanSurakshaScheme
func (ups UrbanSurakshaScheme) Validate() error {
	if ups.SchemeID == "" {
	...
	if ups.ContributionPeriod != UrbanSurakshaContributionPeriod {
...
func (ups UrbanSurakshaScheme) CalculateEducationLoanRate() sdk.Dec {
...
func (ups UrbanSurakshaScheme) CalculateInsurancePremium(lifeCover, healthCover sdk.Coin) sdk.Coin {
...
func (ups UrbanSurakshaScheme) IsEligibleForEducationLoan() bool {

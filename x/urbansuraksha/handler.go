...
func NewHandler(k keeper.Keeper) sdk.Handler {
	...
	return func(ctx sdk.Context, msg sdk.Msg) (*sdk.Result, error) {
		...
		switch msg := msg.(type) {
		case *types.MsgCreateUrbanSurakshaScheme:
			res, err := msgServer.CreateUrbanSurakshaScheme(sdk.WrapSDKContext(ctx), msg)
		...
		case *types.MsgProcessSurakshaMaturity:
			res, err := msgServer.ProcessSurakshaMaturity(sdk.WrapSDKContext(ctx), msg)
			return sdk.WrapServiceResult(ctx, res, err)

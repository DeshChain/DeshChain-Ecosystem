...
// SurakshaScheme represents a pension scheme configuration
type SurakshaScheme struct {
...
// SurakshaParticipant represents a participant in a pension scheme
type SurakshaParticipant struct {
...
// SurakshaContribution represents a single contribution
...
// SurakshaMaturity represents a matured pension account
type SurakshaMaturity struct {
...
// Validate performs basic validation on SurakshaScheme
func (ps SurakshaScheme) Validate() error {
	if ps.SchemeID == "" {
...
// Validate performs basic validation on SurakshaParticipant
func (pp SurakshaParticipant) Validate() error {
	if pp.ParticipantID == "" {
...
func (ps SurakshaScheme) CalculateMaturityAmount(totalContributed sdk.Coin) sdk.Coin {
...
func (ps SurakshaScheme) IsEligible(age uint32) bool {
...
func (ps SurakshaScheme) GetLiquidityAmount(contribution sdk.Coin) sdk.Coin {

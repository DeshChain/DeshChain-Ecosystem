...
func initTendermintConfig() *tmcfg.Config {
	...
	// DeshChain specific configurations
...
func initAppConfig() (string, interface{}) {
	...
	//
	// In DeshChain, we set this to 0.00001namo.
	srvCfg.MinGasPrices = "0.00001namo"
...
// newApp creates a new DeshChainApp
...
// appExport creates a new DeshChainApp (optionally at a given height)
func appExport(
...
// newAppCreator returns an app creator.
func newAppCreator(encCfg params.EncodingConfig) appCreator {
	return appCreator{
		encCfg: encCfg,
	}
}
...
func (a appCreator) appExport(
	...
	return appExport(logger, db, traceStore, height, forZeroHeight, jailAllowedAddrs, appOpts, modulesToExport)
}

func addGenesisAccountCmd(defaultNodeHome string) *cobra.Command {
	cmd := genutilcli.AddGenesisAccountCmd(defaultNodeHome)
	cmd.RunE = func(cmd *cobra.Command, args []string) error {
		return genutilcli.AddGenesisAccountCmd(defaultNodeHome).RunE(cmd, args)
	}
